...
async function swap(startEvent: EnhancedMouseEvent, moveEvent: EnhancedMouseEvent) {
  ...
  pause()
  // if (startGroup === 'group1' && targetGroup === 'group1') {
  //   if (startIndex === targetIndex) return
  //   // 对第一个列表进行排序
  //   _swap(unref(list1Ref), startIndex, targetIndex)
  //
  //   return
  // }

  // if (startGroup === 'group2' && targetGroup === 'group2') {
  //   if (startIndex === targetIndex) return
  //   // 对第二个列表进行排序
  //   _swap(unref(list2Ref), startIndex, targetIndex)
  //   pause()
  //   return
  // }

  // if (startGroup === 'group1' && targetGroup === 'group2') {
  //   console.log(startEvent.target)
  //   // 左边到右边
  //   crossSwap(
  //     { data: unref(list1Ref), index: startIndex },
  //     { data: unref(list2Ref), index: targetIndex },
  //   )
  ...
  // if (startGroup === 'group2' && targetGroup === 'group1') {
  //   // 右边到左边
  //   if ((~startIndex) || (~targetIndex)) return
  //   crossSwap(
  //     { data: unref(list2Ref), index: targetIndex },
